...
// index 0 = { id: 1, nombre: "Ana", edad: 25, activo: true }
// callback(usuario, index, array)
...
console.log("Con saludo:", usuariosConSaludo);
...
console.log(
  "Usuarios por edad:",
  usuariosOrdenados.map((u) => `${u.nombre} (${u.edad})`),
);
